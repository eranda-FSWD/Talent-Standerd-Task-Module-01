    ...
    public class ProfileController : Controller
    {
        ...
        public async Task<ActionResult> AddLanguage([FromBody] AddLanguageViewModel language)
        {
            try
            {
                ...
                {
                    return Json(new { Success = true, Message = "A New Language added Successfully" });
                }
                return Json(new { Success = false, Message = "Unable to add a New Language" });
            }
            catch(Exception e)
            {
                return Json(new { Success = false, Message = "Unable to add a New Language"});
        ...
        public async Task<ActionResult> UpdateLanguage([FromBody] AddLanguageViewModel language)
        {
            try
            {
                ...
                return Json(new { Success = false, Message = "Unable to updated Language" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to updated Language" });
        ...
        public async Task<ActionResult> DeleteLanguage([FromBody] AddLanguageViewModel language)
        {
            ...
            try
            {
                ...
                return Json(new { Success = false, Message = "Unable to delete Language" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to delete Language" });
        ...
        public async Task<ActionResult> AddSkill([FromBody]AddSkillViewModel skill)
        {
            try
            {
                ...
                {
                    return Json(new { Success = true, Message = "A new Skill added Successfully" });
                }
                return Json(new { Success = false, Message = "Unable to add a new Skill" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to add a new Skill" });
        ...
        public async Task<IActionResult> UpdateSkill([FromBody]AddSkillViewModel skill)
        {
            try
            {
                ...
                return Json(new { Success = false, Message = "Unable to update Skill" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to update Skill" });
        ...
        public async Task<IActionResult> DeleteSkill([FromBody]AddSkillViewModel skill)
        {
            try
            {
                ...
                return Json(new { Success = false, Message = "Unable to delete Skill" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to delete Skill" });
        ...
        public async Task<ActionResult> AddExperience([FromBody] ExperienceViewModel experience)
        {
            try
            {
                ...
                {
                    return Json(new { Success = true, Message = "A new Experience added Successfully" });
                }
                return Json(new { Success = false, Message = "Unable to add a new Experience" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to add a new Experience" });
        ...
        public async Task<ActionResult> UpdateExperience([FromBody] ExperienceViewModel experience)
        {
            try
            {
                ...
                return Json(new { Success = false, Message = "Unable to update Experience" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to update Experience" });
        ...
        public async Task<ActionResult> DeleteExperience([FromBody] ExperienceViewModel experience)
        {
            try
            {
                ...
                {
                    return Json(new { Success = true, Message = "Experience deleted Successfully" });
                }
                return Json(new { Success = false, Message = "Unable to delete Experience" });
            }
            catch (Exception e)
            {
                return Json(new { Success = false, Message = "Unable to delete Experience" });
